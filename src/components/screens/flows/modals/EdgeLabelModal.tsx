...
export function EdgeLabelModal({ theme, edge, onClose, onSave, onDelete }: EdgeLabelModalProps) {
    ...
    >
      ...
      >
        <div className="flex justify-between items-center mb-6">
          <h3 className="font-semibold text-lg" style={{ color: theme.text }}>接続ラベルを編集</h3>
        ...
        <div className="space-y-4">
          ...
          <button
            onClick={onDelete}
            className="w-full py-3 rounded-xl text-red-500 text-sm"
