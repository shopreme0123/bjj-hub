...
import { Plus, Search, ChevronRight, Filter, Star, Trash2, Pencil, Download, Upload } from 'lucide-react';
        ...
        >
          ...
          <div className="relative">
            ...
            <button
              ...
              style={{ background: showFilters ? theme.gradient : 'transparent' }}
            >
              <Filter
                size={18}
            ...
            <div className="flex flex-wrap gap-2 animate-fade-in">
              {techniqueTypes.map((type) => (
                <button
                  ...
                  style={{
                    background: selectedType === type.value ? theme.gradient : theme.card,
          ...
          <div>
            ...
            <div className="flex gap-2 overflow-x-auto pb-2 scrollbar-hide">
              <button
                ...
                style={{
                  background: selectedCategory === null ? theme.gradient : theme.card,
              ...
              {categories.map((cat) => (
                <div key={cat.id} className="relative group flex-shrink-0">
                  <button
                    ...
                    style={{
                      background: selectedCategory === cat.id ? theme.gradient : theme.card,
