...
export function TechniquesScreen({ onSelectTechnique }: TechniquesScreenProps) {
  ...
  const isModalOpen = showAddTechniqueModal || showAddCategoryModal || !!editingCategory || showImportModal;
  ...
  return (
    <div className="flex flex-col h-full min-h-0" style={{ background: theme.bg }}>
      <Header
      ...
      {/* スクロール可能なコンテンツ */}
      <div
        className="flex-1 px-4 pt-2 space-y-4 app-scroll-area min-h-0"
