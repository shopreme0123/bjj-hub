...
import { TechniqueDetailScreen } from '@/components/screens/techniques/TechniqueDetailScreen';
import { FlowsScreen } from '@/components/screens/flows/FlowsScreen';
import { FlowEditorScreen } from '@/components/screens/flows/FlowEditorScreen';
...
import { GroupDetailScreen } from '@/components/screens/groups/GroupDetailScreen';
...
function SplashScreen() {
  return (
    <div className="h-screen w-full flex flex-col items-center justify-center bg-black">
      ...
      <h1 className="text-2xl font-bold text-white mb-2">Your BJJ</h1>
...
export default function HomePage() {
  useEffect(() => {
    ...
    const previousBodyPaddingLeft = document.body.style.paddingLeft;
    ...
    return () => {
      ...
      document.body.style.paddingLeft = previousBodyPaddingLeft;
